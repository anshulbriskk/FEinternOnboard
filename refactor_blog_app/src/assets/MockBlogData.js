const MockBlogData = [
  {
    ...
    subtitle:
      "Minus eum dolor enim. Dignissimos sit aperiam rerum laborum ut voluptatem.",
    summary:
      "Molestiae ut est dolorem a vero et in. Dignissimos id et dolore consequuntur explicabo doloremque soluta. Deserunt repudiandae soluta nulla neque aut recusandae sed non. Itaque velit neque dicta dolores fuga dicta sunt.",
    ...
    user: {
      id: "aec92dd8-79dd-4b22-9deb-a2af00d568c8",
      first_name: "Heath",
      middle_name: "Padberg",
      last_name: "Hills",
      email: "ernesto.muller_prosacco.kayli@example.net",
      contact_id: "227b5217-f3e4-4086-bef6-75f4acaea47a",
      address_id: "2278241b-bb32-4574-8fb6-b1c24f812c6c",
      username: "alycia662571",
      role: "Adjustment Clerk",
      profile_pic:
        "https://images.unsplash.com/photo-1568822617270-2c1579f8dfe2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0OTE2MTF8MHwxfHNlYXJjaHwxOXx8RnJpZW5kc3xlbnwwfDJ8fHwxNjk3MzYzOTE1fDA&ixlib=rb-4.0.3&q=80&w=400",
  ...
  },
  {
    ...
    user_id: "61aa2cd5-978b-45f6-b592-9964ac04c855",
    title: "Nesciunt eligendi qui delectus quia blanditiis.",
    subtitle:
      "Et iste omnis est explicabo eos. Sunt blanditiis quam ad libero est asperiores et.",
    summary:
    ...
    updated_at: "Sun, 10/15/2023",
    user: {
      id: "61aa2cd5-978b-45f6-b592-9964ac04c855",
      first_name: "Andre",
      middle_name: "Jenkins",
      last_name: "Flatley",
      email: "isaiah.douglas_estefania88@example.net",
      contact_id: "ad532dd9-25a2-44dc-94f5-f56a9ab39296",
      address_id: "aaedd93e-400e-42b1-81a8-8e8d88615cb8",
      username: "lesch.blaise5895",
      role: "Software Engineer",
      profile_pic:
        "https://images.unsplash.com/photo-1543363575-d306a0b37c9c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0OTE2MTF8MHwxfHNlYXJjaHwyOHx8Rm9vZHxlbnwwfDJ8fHwxNjk3MzYzOTM0fDA&ixlib=rb-4.0.3&q=80&w=400",
      email_verified_at: null,
      created_at: "Sun, 10/15/2023",
      updated_at: "Sun, 10/15/2023",
    },
  ...
  },
  {
    ...
    user_id: "8dfb2fe0-980a-4132-a5a3-c35cb4673be6",
    title: "Quae praesentium consequatur vel eligendi iste nisi.",
    subtitle:
      "Consectetur inventore distinctio aperiam suscipit dolorum. Maxime neque praesentium quasi et qui.",
    summary:
      "Vel ipsum aut qui quo consectetur vel. Illo neque maiores dicta sunt ipsam. A consequatur assumenda expedita assumenda. Minus assumenda consectetur reiciendis.",
    ...
    updated_at: "Sun, 10/15/2023",
    user: {
      id: "8dfb2fe0-980a-4132-a5a3-c35cb4673be6",
      first_name: "Rylee",
      middle_name: "McClure",
      last_name: "O'Kon",
      email: "katlyn.corkery_heaney.emerson@example.net",
      contact_id: "29f5c0f4-9b4b-4ae6-8b28-ca82fe648645",
      address_id: "2a5b2185-2021-4c00-a903-6226363fb0bc",
      username: "zbradtke7096",
      role: "Mixing and Blending Machine Operator",
      profile_pic:
        "https://images.unsplash.com/photo-1617791169544-1ba998b069e4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0OTE2MTF8MHwxfHNlYXJjaHwxM3x8QmFieXxlbnwwfDJ8fHwxNjk3MzYzOTE3fDA&ixlib=rb-4.0.3&q=80&w=400",
      email_verified_at: null,
      created_at: "Sun, 10/15/2023",
      updated_at: "Sun, 10/15/2023",
    },
    comments: [
      {
        id: "1f8dd033-75fb-4a12-a06f-cecc053d785a",
        user_id: "b6a9005c-d26b-49d3-8be0-2845b8f25534",
        blog_post_id: "006ad48b-e9d9-472e-bcc0-39961ef18eba",
        main_content:
          "Vero qui vel quo aut laborum tempore tempora. Velit exercitationem consectetur dolorum natus maxime explicabo sint.",
        created_at: "Sun, 10/15/2023",
        updated_at: "Sun, 10/15/2023",
      },
    ],
  ...
  },
  {
    ...
    user_id: "f0aeec22-03c8-4648-92dc-bbea8e4366d6",
    ...
    updated_at: "Sun, 10/15/2023",
    user: {
      id: "f0aeec22-03c8-4648-92dc-bbea8e4366d6",
      first_name: "Al",
      middle_name: "Kilback",
      last_name: "Carter",
      email: "johns.jerry_cbogan@example.net",
      contact_id: "e1e9eb41-ebc9-4c27-8e24-b0bf6eff9d72",
      address_id: "de7f2f3a-8488-49f9-94e7-0b5e04ae1b1a",
      username: "mattie.batz4359",
      role: "Artist",
      profile_pic:
        "https://images.unsplash.com/photo-1647541736304-e5d7ce6f3f54?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0OTE2MTF8MHwxfHNlYXJjaHw3fHxGZXN0aXZhbHxlbnwwfDJ8fHwxNjk3MzYzOTQyfDA&ixlib=rb-4.0.3&q=80&w=400",
      email_verified_at: null,
      created_at: "Sun, 10/15/2023",
      updated_at: "Sun, 10/15/2023",
    },
    ...
    tags: [
      {
        id: "597a1751-71fa-448b-8500-c4428216b989",
        blog_post_id: "00caf75b-0d8f-441c-ae04-1dd25a790683",
        name: "Food",
        created_at: "Sun, 10/15/2023",
        updated_at: "Sun, 10/15/2023",
      },
  ...
  },
  {
    ...
    user_id: "3b070207-49cd-422d-81da-28ae3474fdda",
    ...
    updated_at: "Sun, 10/15/2023",
    user: {
      id: "3b070207-49cd-422d-81da-28ae3474fdda",
      first_name: "Florine",
      middle_name: "Price",
      last_name: "Cummerata",
      email: "daren.parker_marge.marks@example.net",
      contact_id: "2f8367a4-9555-4c18-8f17-cbdf787698d6",
      address_id: "2f4cd9d9-364d-4a9e-9112-acd3bf763d8e",
      username: "domingo749552",
      role: "Pile-Driver Operator",
      profile_pic:
        "https://images.unsplash.com/photo-1576089172869-4f5f6f315620?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0OTE2MTF8MHwxfHNlYXJjaHw4fHxUZWVuYWdlcnxlbnwwfDJ8fHwxNjk3MzYzOTE3fDA&ixlib=rb-4.0.3&q=80&w=400",
      email_verified_at: null,
      created_at: "Sun, 10/15/2023",
      updated_at: "Sun, 10/15/2023",
    },
